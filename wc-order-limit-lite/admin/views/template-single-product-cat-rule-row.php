...
/**
 *
 * Single product category ajax rule page of plugin.
 *
...
<div class="wcol_single_cat_rule wcol-new wcol_single_cat_rule_open">
	<input type="hidden" name="wcol_rules[id][<?php esc_html( $spcid ); ?>]" value="<?php echo esc_attr( uniqid() ); ?>"/>
	<h3 class="wcol_cat_accordion"><?php esc_html_e( 'New Rule(Not Saved)', 'order-limit-for-woocommerce' ); ?><span class="wcol-delete" data-id="<?php echo esc_attr( uniqid() ); ?>"><?php esc_html_e( 'Delete', 'order-limit-for-woocommerce' ); ?></span></h3>
	<div class="wcol_cat_panel" style="display:block">
		<div class="options_group">
			<p class="form-field">
				<label><?php esc_html_e( 'Minimum Order', 'order-limit-for-woocommerce' ); ?>:</label>
				<input type="number" min="0"  name="wcol_rules[min-rule-limit][<?php esc_html( $spcid ); ?>]" class="wcol-rule-min-limit" value="" placeholder="<?php esc_html_e( 'Enter Minimum Order Limit', 'order-limit-for-woocommerce' ); ?>" />
			</p>
		...
		<div class="options_group">  
			<p class="form-field">
				...
				<select class="across-all-orders-limit" name="wcol_rules[across-all-orders][<?php esc_html( $spcid ); ?>]">
		...
		<div class="options_group">
			<p class="form-field">
				...
				<input type="hidden" class="wcol-loop-checkbox-hidden enable-max-rule-limit-hidden" name="wcol_rules[enable-max-rule-limit][<?php esc_html( $spcid ); ?>]" />
			...
			<p class="form-field wcol-hidden">
				...
				<input type="number" class="wcol-rule-max-limit" min="0"  name="wcol_rules[max-rule-limit][<?php esc_html( $spcid ); ?>]" value="" placeholder="<?php esc_html_e( 'Enter Maximum Order Limit', 'order-limit-for-woocommerce' ); ?>" />
			</p>
		</div>
		<div class="options_group">
			<p class="form-field">
				<label><?php esc_html_e( 'Enable Time Span', 'order-limit-for-woocommerce' ); ?>:</label>
				<input type="hidden" class="wcol-loop-checkbox-hidden enable-time-limit-hidden" name="wcol_rules[enable-time-limit][<?php esc_html( $spcid ); ?>]" />
			...
			<p class="form-field wcol-hidden">
				...
				<select class="wcol-rule-time-span" name="wcol_rules[rule-time-span][<?php esc_html( $spcid ); ?>]">
			...
			<p class="form-field wcol-hidden">
				...
				<input type="number" max="31" min="01" class="wcol-yearly-start-day" name="wcol_rules[yearly-start-day][<?php esc_html( $spcid ); ?>]" value="01" disabled />
				<select class="wcol-yearly-start-month" name="wcol_rules[yearly-start-month][<?php esc_html( $spcid ); ?>]" disabled >
					<?php
			...
			<p class="form-field wcol-hidden">
				...
				<select class="wcol-weekly-start-day" disabled name="wcol_rules[weekly-start-day][<?php esc_html( $spcid ); ?>]">
					<?php
			...
			<p class="form-field wcol-hidden">
				...
				<input class="wcol-rule-days" type="number" name="wcol_rules[days][<?php esc_html( $spcid ); ?>]" value="01" disabled />
			</p>
			<p class="form-field wcol-hidden">
				<label><?php esc_html_e( 'Month Start Date:(Pro)', 'order-limit-for-woocommerce' ); ?></label>
				<input class="wcol-monthly-start-date" type="number" min="01" max="31" name="wcol_rules[monthly-start-date][<?php esc_html( $spcid ); ?>]" value="01" disabled />
			</p>
			<p class="form-field wcol-hidden">
				<label><?php esc_html_e( 'Start Time(Pro)', 'order-limit-for-woocommerce' ); ?>:</label>
				<input type="text" class="wcol-rule-start-time" name="wcol_rules[rule-start-time][<?php esc_html( $spcid ); ?>]" disabled />
			</p>
			<p class="form-field wcol-hidden">
				<label><?php esc_html_e( 'End Time(Pro)', 'order-limit-for-woocommerce' ); ?>:</label>
				<input type="text" class="wcol-rule-end-time" name="wcol_rules[rule-end-time][<?php esc_html( $spcid ); ?>]" disabled />
			</p>
		</div>
		<div class="options_group">
			<p class="form-field">
				<label><?php esc_html_e( 'Applied on', 'order-limit-for-woocommerce' ); ?>:</label>
				<select name="wcol_rules[applied_on][<?php esc_html( $spcid ); ?>]" >
		...
		<div class="options_group">                                                                  
			<p class="form-field">
				...
				<input type="hidden" class="wcol-loop-checkbox-hidden" name="wcol_rules[enable-for-users][<?php esc_html( $spcid ); ?>]" />
			...
			<p class="form-field wcol-hidden">
				...
				<select class="wcol-rule-user-type" name="wcol_rules[user-type][<?php esc_html( $spcid ); ?>]">
			...
			<p class="form-field wcol-hidden">
				...
				<select class="wcol-select-guest-users wcol-rule-guest-users" name="wcol-rules[rule-guest-users][<?php esc_html( $spcid ); ?>][]" multiple="multiple" disabled >
			...
			<p class="form-field wcol-hidden">
				...
				<select class="wcol-select-users wcol-rule-users" disabled name="wcol_rules[rule-users][<?php esc_html( $spcid ); ?>][]" ></select>
			</p>
			<p class="form-field wcol-hidden">
				<label><?php esc_html_e( 'Roles(Pro)', 'order-limit-for-woocommerce' ); ?>:</label>
				<select class="wcol-select-roles wcol-rule-roles" disabled name="wcol_rules[rule-roles][<?php esc_html( $spcid ); ?>][]" ></select>
			</p>
		</div>
		<div class="options_group">
			<p class="form-field">
				<label><?php esc_html_e( 'Enable for Payment Method:', 'order-limit-for-woocommerce' ); ?></label>
				<input type="hidden" class="wcol-loop-checkbox-hidden"  name="wcol_rules[enable-for-payment][<?php esc_html( $spcid ); ?>]"/>
			...
			<p class="form-field wcol-payment-method wcol-hidden">
				...
				<select class="wcol-rule-payment-type" disabled name="wcol-rules[payment-method][<?php esc_html( $spcid ); ?>][]" multiple="multiple">
					<?php
